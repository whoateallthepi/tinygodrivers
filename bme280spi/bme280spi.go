...
// DeviceSPI is the SPI interface to a BME280. There is
// also an I2C interface, see tinygo.org/x/drivers/bme280
...
// configures the BME280. Assumes the SPI interface i running
